...
| **C.1** Auditoría sistema Shadow | WR/PF/expectancy/DD por estrategia × horario × vol × liquidez; comparativa | Ejecutable ya (siguiente tras A.1); con n chicos el output es honesto (tiers), no veredicto |
